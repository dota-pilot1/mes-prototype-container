...
public class MenuSeeder implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) {
        List<MenuDef> defs = List.of(
                ...
                new MenuDef("PRODUCTION_PLAN_PAGE",  "PRODUCTION_PLAN", "페이지", "nav.page",          "/production-plans", "CalendarClock",   null,                    0),
                new MenuDef("PRODUCTION_PLAN_REVIEW","PRODUCTION_PLAN", "코드 리뷰", "nav.codeReview",  "/production-plans/review", "ShieldCheck", null,                    1),
                new MenuDef("EQUIPMENT_RESERVATION", null,    "설비예약",      "nav.equipmentReservation", null,            "Settings",        null,                    3),
                ...
                new MenuDef("WORK_ORDER",            null,    "작업지시",      "nav.workOrder",        null,                "ClipboardList",   null,                    4),
                new MenuDef("WORK_ORDER_PAGE",       "WORK_ORDER", "페이지",   "nav.page",             "/work-orders",      "ClipboardList",   null,                    0),
                new MenuDef("WORK_ORDER_REVIEW",     "WORK_ORDER", "코드 리뷰","nav.codeReview",       "/work-orders/review", "ShieldCheck",   null,                    1),
